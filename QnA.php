...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <p class=" answer">A: There are tons of stories about how kids grow up programming, learning C++ before they even get to high school, but that is not my story. To be honest, the first time I had experience writing code was anything but a lightbulb moment for me. I was going through a coding bootcamp with Columbia SIAM, and I was the the least competent out of all of my friends. I couldn't understand the relationship between the code and the machine. It took a two years before I built up the courage to try again, and this time it was an independent study to build a "feature rich" website for my rock climbing team. After putting in the hours, figuring out solutions to technical problems like connecting local database to a website with PHP without any real guidance, I was hooked.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body ca" onclick="revealQuestion(1)" >
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body cb" onclick="revealQuestion(2)">
...
mind moving. During the school year, I am studing at Marist college and I am on track to graduate in the spring of 2022. I am pursuing a BS in Computer 
