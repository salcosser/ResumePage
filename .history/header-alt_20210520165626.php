            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-top:-5%;border: none;width:.85;font-size:2vmin" style=" transition-property: background-color, color;sition-duration: .5s;background-color:transparent!" class="card-footer">
