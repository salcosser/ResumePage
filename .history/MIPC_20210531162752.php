...
<p class="project-copy">
    ...
    &nbspBeyond just learning about Play Framework, this project has also given me the opportunity to learn and experiment with other technologies. For example, one feature that was to be implemented for the client was an email system to notify users of errors in record processing. For the email system to work, I taught myself how to use dependency injection to correctly send the emails. Beyond dependency injection, the real improvements came from me learning about threading in Java. I was nervous about the emails slowing down the batch process, so I put the emails on threads. Another feature that was refactored to use threads was a sequential process that was taking upwards of 45 minutes to process in some cases. After utilizing threads, this process was running in around 5 minutes.
 </div>
