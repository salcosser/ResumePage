    ...
    <button id="toggle-btn" class="btn" onclick="toggleMode()">Toggle Light / Dark Mode</button>
      ...
      <div class="row" id="links">
        ...
        <ul class="list-unstyled" >
          ...
          <li> <code>13</code> <span style="color:rgb(141, 220, 246)">System.out.</span><span style="color:lightgreen">println</span>(<span style="color:darkorange !important">"<a href="Resume-Jul20.pdf">Resume</a>"</span>);</li>   
